...
city_df_30min_345 = pd.read_csv('/home/diluisi/Documentos/BID_Project/Projeto_Final/sp_30min_345.csv',parse_dates=['30min'])
city_df_30min_345['length'] = city_df_30min_345['length']/1000
city_df_30min_45 = pd.read_csv('/home/diluisi/Documentos/BID_Project/Projeto_Final/sp_30min_45.csv',parse_dates=['30min'])
city_df_30min_45['length'] = city_df_30min_45['length']/1000
                    ...
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[
                                dcc.DatePickerRange(
                                    id="date-picker",
                                    min_date_allowed=dt.datetime(2019, 3, 1),
                                    max_date_allowed=dt.datetime(2019, 4, 1),
                                    initial_visible_month=dt.datetime(2019, 3, 1),
                                    start_date=dt.datetime(2019, 3, 1).date(),
